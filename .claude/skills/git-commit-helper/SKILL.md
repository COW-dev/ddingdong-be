...
description: Generate descriptive commit messages by analyzing git diffs. Use PROACTIVELY when the user asks to commit, wants a commit message, or after completing a task and preparing to commit.
hooks:
  PostToolUse:
    - matcher: "Bash"
      hooks:
