...
sealed public class ConvertException extends CustomException {
    ...
    private static final String MAP_TO_STRING_CONVERT_ERROR_MESSAGE = "문자열을 Map으로 변환하는 것에 실패하였습니다.";
    private static final String STRING_TO_MAP_CONVERT_ERROR_MESSAGE = "Map을 문자열로 변환하는 것에 실패하였습니다.";
    ...
    public static final class StringToMapConvertException extends ConvertException {

        public StringToMapConvertException() {
            super(STRING_TO_LIST_CONVERT_ERROR_MESSAGE, INTERNAL_SERVER_ERROR.value());
        }
    }

    public static final class MapToStringConvertException extends ConvertException {

        public MapToStringConvertException() {
            super(LIST_TO_STRING_CONVERT_ERROR_MESSAGE, INTERNAL_SERVER_ERROR.value());
        }
    }
}
