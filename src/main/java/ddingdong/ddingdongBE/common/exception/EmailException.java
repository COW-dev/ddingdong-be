...
public class EmailException extends CustomException {
    ...
    private static final String NO_EMAIL_SEND_TARGET_MESSAGE = "해당 상태의 지원자가 없어 이메일을 전송할 수 없습니다.";
    ...
    public static final class NoEmailSendTargetException extends EmailException {

        public NoEmailSendTargetException() {
            super(NO_EMAIL_SEND_TARGET_MESSAGE, BAD_REQUEST.value());
        }
    }
