...
import ddingdong.ddingdongBE.domain.notice.service.FacadeAdminNoticeServiceImpl;
...
public class AdminNoticeController implements AdminNoticeApi {
    ...
    private final FacadeAdminNoticeServiceImpl facadeAdminNoticeServiceImpl;

    @Override
    public void createNotice(CreateNoticeRequest request, PrincipalDetails principalDetails) {
        User user = principalDetails.getUser();
        facadeAdminNoticeServiceImpl.create(request.toCommand(user));
    }

    @Override
    public void updateNotice(Long noticeId, UpdateNoticeRequest request) {
        facadeAdminNoticeServiceImpl.update(request.toCommand(), noticeId);
    }

    @Override
    public void deleteNotice(@PathVariable Long noticeId) {
        facadeAdminNoticeServiceImpl.delete(noticeId);
    }
